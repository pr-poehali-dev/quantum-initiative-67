          ...
          <div className="flex max-w-2xl flex-col gap-10">
            ...
            >
              ...
              <p className="mt-4 text-lg text-white/70 max-w-md">
                Профессиональная команда промышленных альпинистов. Выполняем высотные работы любой сложности — быстро, безопасно и с гарантией качества.
              </p>
            </div>
            ...
            >
              <div className="flex flex-wrap gap-2 mb-8">
                {services.map((service) => (
                  <span
                    key={service}
                    className="px-3 py-1 text-sm border border-white/20 text-white/80 rounded-full backdrop-blur-sm"
                  >
                    {service}
                  </span>
                ))}
